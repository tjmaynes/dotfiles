...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nov elfeed-web elfeed emms zenburn-theme web-mode w3m org-journal multi-term markdown-mode magit k8s-mode json-mode dockerfile-mode clj-refactor auto-complete align-cljlet))))
(custom-set-faces
